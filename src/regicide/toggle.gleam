...
pub fn toggle(
  ...
  html.div(
    [attribute.class("group relative flex flex-row content-center gap-1")],
    [
      html.span([], [html.text(left |> label)]),
      html.div(
        [
          attribute.class(
            "relative inline-flex h-5 w-10 shrink-0 items-center self-center justify-center rounded-full outline-offset-2 outline-indigo-600 has-focus-visible:outline-2",
          ),
        ],
        [
          html.span(
